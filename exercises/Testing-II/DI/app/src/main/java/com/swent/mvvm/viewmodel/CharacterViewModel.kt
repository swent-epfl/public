...
// TODO: add correct `@` annotations and change class definition below for dependency injection for ViewModel
class CharacterViewModel(application: Application) : AndroidViewModel(application) {

    // TODO: remove the following statement as repository is now a dependency of CharacterViewModel

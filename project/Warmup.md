...
This document will guide through some preparatory steps that will set you and your team up for success.
These steps are intended to be taken prior to the first formal meeting with your coaches, in which you will be planning your Sprint 1.

The goal of this warmup is to enable you to:
- **Collaborate effectively:** by ensuring that the team has a good collaborative setup; and
- **Plan well:** You know what they say: _The difference between a dream and a goal is a plan._  While dreams and goals may start as similar ideas, a plan is what turns a dream into an achievable, concrete goal. So you need to lay the groundwork for your project by setting up tools, planning tasks, and preparing for the first coaching meeting.

The last bootcamp milestone (B3) is due on Monday at midnight.
We suggest that, after you complete B3, you take a couple of days to do the [initial infrastructure setup](#initial-setup) and then you meet as a team to [prepare for Sprint 1](#prepare-for-sprint-1).
...
- [ ] Create a project repository; make sure that it's public, so that you can use tools like SonarCloud for free.
- [ ] Grant _Maintainer_ access to your coaches, so that they can give you the right level of help.
...
- [ ] Initialize the Android project in GitHub (you can use our [sample Android project](https://github.com/swent-epfl/Android-Sample) as a starting point, or your bootcamp).
...
- [ ] Add the following columns to your board:
     ...
     - `In Review` for the tsks under review by other team members before being merged.
...
- [ ] Define properties for tasks on the Scrum board:
     ...
     - `Estimated Time` where you will put your best guess as how many person-hours it will take to complete the task
...
**6. Set up Figma :**
During the semester, you will use Figma to create mockups and track design work.
...
- [ ] Ensure your Figma is publicly accessible, so that your coaches and Prof. Candea have access to it.
...
- [ ] Define a clear **code review process** and set expectations for what a good pull request should look like (see [these guidelines from last semester](https://github.com/swent-epfl/public/tree/main/project/README.md#code-reviews)).
...
- [ ] Plan a team calendar (optional) and standup meetings (mandatory). Schedule regular standups to keep the team on track.
...
- [ ] For each Sprint, one of you will have to be Scrum Master.  Discuss how you want to rotate this role, such that each team member can do it as often as possible during the semester.  The Scrum Master will also be a Developer, just not at 100%.

**2. Risk Planning :**
- Identify potential risks early on, such as unfamiliar technology, and document them.
- Consider whether the team has the necessary knowledge and resources to overcome these risks (e.g., finding and using an API for the idea you want to implement). Evaluate factors such as whether the API is publicly available, its cost, whether it meets the project's requirements, and if it even exists or can be easily integrated into your solution.
...
- [ ] Add tasks to the Scrum board and assign them to the relevant team members; ensure that everyone has **one task to complete** before Friday 4.10.2024.
...
By following this comprehensive checklist, your team will be well-prepared to collaborate effectively, initiate your project successfully, and make the most of your Sprint 1 planning and execution.